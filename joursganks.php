<div class="container mt-4 border-left border-right">
    ...
    <li class="nav-item">
        <a href="index.php?page=jours" class="nav-link text-dark">Victoires/défaites de la semaine</a>
    </li>
    <li class="nav-item">
        <a href="index.php?page=joursGank" class="nav-link active bg-dark text-light">Ganks de la semaine</a>
    </li>
</ul>
<div class="d-flex justify-content-around flex-wrap mt-4">
    ...
    foreach ($joursSemaine as $jour) {
        ...
        $resultsForDay = getGanksForToday($jour);
    ...
    <script>
        ...
        Object.keys(dataFromPHPResults).forEach(day => {
            ...
            const labels = dataForDay.map(entry => entry.gank);
            ...
            new Chart(ctx, {
                ...
                data: {
                    labels: labels,
                    datasets: [{
                        label: `Nombre de Ganks pour ${day}`,
                        data: data,
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: { display: true, text: `Nombre de Ganks pour ${day}` },
                        datalabels: {
                            display: true,
